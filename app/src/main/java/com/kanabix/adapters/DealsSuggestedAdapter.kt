...
class DealsSuggestedAdapter(
    var context: Context, var data: ArrayList<ProductListDoc>, var productClick: ProductClick, var wishListClick : WishListClick
) :   RecyclerView.Adapter<DealsSuggestedAdapter.ViewHolder>() {
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        holder.unLikeHeart.setOnClickListener {
            ...
            if (!Data.isliked){
                wishListClick.wishListClick(Data.id)
//                holder.LikeHeart.visibility = View.VISIBLE
//                holder.unLikeHeart.visibility = View.GONE
            }
        }
