...
class StoreLikeListResponse {
    @SerializedName("result")
    val result: StoreLikeListResult = StoreLikeListResult()
...
class StoreLikeListResult {
    @SerializedName("docs")
    val docs: ArrayList<StoreLikeListDoc> = ArrayList()
...
class StoreLikeListDoc {
    @SerializedName("status")
    val status: String = ""
    @SerializedName("_id")
    val id: String = ""
    @SerializedName("storeId")
    val storeId: StoreLikeListStoreId = StoreLikeListStoreId()
...
class StoreLikeListStoreId {
    @SerializedName("store")
    val store: StoreLikeListStore = StoreLikeListStore()
