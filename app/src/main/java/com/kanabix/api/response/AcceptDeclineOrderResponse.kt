...
class AcceptDeclineOrderResponse {
    @SerializedName("result")
    val result: AcceptDeclineOrderResult = AcceptDeclineOrderResult()
...
class AcceptDeclineOrderResult {
...
//    val trackingArray: List<AcceptDeclineOrderAny> = listOf()
    ...
    val shippingFixedAddress: AcceptDeclineOrderShippingFixedAddress = AcceptDeclineOrderShippingFixedAddress()
    @SerializedName("productDetails")
    val productDetails: ArrayList<AcceptDeclineOrderProductDetail> = ArrayList()
...
class AcceptDeclineOrderShippingFixedAddress {
...
class AcceptDeclineOrderProductDetail {
    @SerializedName("_id")
    val id: String = ""
