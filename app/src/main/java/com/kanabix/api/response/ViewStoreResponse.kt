...
class ViewStoreResponse {
    @SerializedName("result")
    val result: ViewStoreResult = ViewStoreResult()
...
class ViewStoreResult {
    @SerializedName("businessBankingDetails")
    val businessBankingDetails: ViewStoreBusinessBankingDetails = ViewStoreBusinessBankingDetails()
    @SerializedName("store")
    val store: ViewStoreStore = ViewStoreStore()
...
class ViewStoreBusinessBankingDetails {
