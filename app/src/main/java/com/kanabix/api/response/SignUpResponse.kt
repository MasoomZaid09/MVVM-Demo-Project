...
class SignUpResponse {
    ...
    val result: SignUpResult = SignUpResult()
...
class SignUpResult {
    ...
    val location: SignUpLocation = SignUpLocation()
    @SerializedName("businessBankingDetails")
    val businessBankingDetails: SignUpBusinessBankingDetails = SignUpBusinessBankingDetails()
...
class SignUpBusinessBankingDetails {
